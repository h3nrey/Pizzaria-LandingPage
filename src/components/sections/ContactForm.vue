<template>
  <div
    class="p-6 flex flex-col gap-8 bg-[#fff] md:px-16 md:py-[3rem] md:rounded-tr-2xl"
  >
    <div class="flex flex-col gap-4">
      <h2
        class="text-[1.75rem] font-bold text-black uppercase font-title md:text-[2.5rem]"
      >
        we love to hear from you
      </h2>
      <p class="text-darkGray font-[600]">
    ...
    <form ref="form" @submit.prevent="sendEmail" class="flex flex-col gap-6">
      <fieldset class="flex">
        ...
        <div class="grid grid-cols-2 gap-4 w-full md:gap-8">
      ...
      <div class="flex flex-col gap-6 md:grid-cols-2 md:grid md:gap-8">
      ...
      <div class="flex flex-col gap-6">
        <div
          class="flex flex-col gap-6 md:grid-cols-2 md:grid md:gap-8"
        ...
        >
          ...
          <div class="flex flex-col">
            <label for="location" class="capitalize text-darkGray font-medium"
              >Select Location</label
            >
            <div class="relative z-0 w-full cursor-pointer">
              <span
                class="absolute z-10 top-1/2 left-[100%] -translate-y-1/2 -translate-x-[100%] p-4 height-full w-[12%] outline-1 outline-darkGray pointer-events-none"
              >
              ...
              >
                ...
                <option
                  ...
                  class="capitalize text-darkGray font-semibold"
                  :value="option.value"
                  :key="index"
                >
                  {{ option.text }}
        ...
        <button
          type="submit"
          class="hover:bg-red text-[1rem] w-fit py-[0.875rem] px-[1.3125rem] uppercase font-mont rounded-[5px] bg-opacity-0 outline outline-2 hover:bg-opacity-100 active:bg-opacity-100 transition-all duration-300 text-red outline-red hover:text-white font-semibold tracking-widest leading-[initial]"
        >
          submit
        </button>
      </div>
...
function sendEmail() {
  ...
  fieldsValue.value = " "; // reseting form
}
